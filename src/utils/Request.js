...
const Request = {
  ...
  /**
     ...
     */
  fetch: async ({
    method, url, params = {}, config = {}, header = {},
  }) => {
    let _method;
    let _params;
    let _url = url;
    const _config = { indicator: true, timeout: 3000, ...config };
    ...
    return RNFetchBlob
      ...
      .then(resp => checkStatus(resp, resp.json()))
  ...
  /**
     ...
     *
     */
  get: (url, params = {}, header = {}, config = {}) => RTRequest.fetch({
    method: 'get', url, params, header, config,
  })
    .then(data => data)
    .catch((error) => {
  ...
  post: (url, params = {}, header = {}, config = {}) => RTRequest.fetch({
    method: 'post', url, params, header, config,
  })
    .then(data => data)
    .catch((error) => {
      // console.log(error.msg);
  ...
  /**
     ...
     *
     */
  upload: (url, body, uploadProgress, successCallBack, failCallBack) => RNFetchBlob
